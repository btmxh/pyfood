...
class FlatGpTree:
    ...
    def __neg__(self) -> "FlatGpTree": ...
    def __add__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __radd__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __sub__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __rsub__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __mul__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __rmul__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __truediv__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
    def __rtruediv__(self, other: "FlatGpTree | float") -> "FlatGpTree": ...
